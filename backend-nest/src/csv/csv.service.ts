...
export class CsvService {
  ...
  proposeMapping(columns:string[]){const mapping: Record<string,string>={}; for(const c of columns){const key=c.toLowerCase(); if(autoMap[key]) mapping[c]=autoMap[key];} return mapping;}
